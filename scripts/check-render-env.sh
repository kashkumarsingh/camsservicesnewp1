...
echo ""
echo "1. Go to Render Dashboard → Your Frontend Service (e.g. cams-frontend-oj5x)"
echo "2. Click 'Environment' tab"
echo "3. Add/Update:"
echo "   Key:   NEXT_PUBLIC_API_URL"
echo "   Value: https://cams-backend-oj5x.onrender.com/api/v1"
...
BACKEND_URL="https://cams-backend-oj5x.onrender.com/api/v1/health"
