  ...
  return (
    <div className="lg:w-1/2">
      <div className="rounded-card border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-1 text-2xs text-slate-500">{REGISTER_FORM.REQUIRED_NOTE}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`block w-full rounded-lg border-2 bg-white px-4 py-3 pr-10 text-gray-900 shadow-sm transition-all duration-200 placeholder:text-gray-400 focus:outline-none focus:ring-2 ${inputBorderClass(touched.name, errors.name, isValid.name)}`}
              />
              {touched.name && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`block w-full rounded-lg border-2 bg-white px-4 py-3 pr-10 text-gray-900 shadow-sm transition-all duration-200 placeholder:text-gray-400 focus:outline-none focus:ring-2 ${inputBorderClass(touched.phone, errors.phone, isValid.phone)}`}
              />
              {touched.phone && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2">
                  {errors.phone ? (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`block w-full rounded-lg border-2 bg-white px-4 py-3 pr-10 text-gray-900 shadow-sm transition-all duration-200 placeholder:text-gray-400 focus:outline-none focus:ring-2 ${inputBorderClass(touched.address, errors.address, isValid.address)}`}
              />
              {touched.address && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2">
                  {errors.address ? (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`block w-full rounded-lg border-2 bg-white px-4 py-3 pr-10 text-gray-900 shadow-sm transition-all duration-200 placeholder:text-gray-400 focus:outline-none focus:ring-2 ${inputBorderClass(touched.postcode, errors.postcode, isValid.postcode)}`}
              />
              {touched.postcode && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2">
                  {errors.postcode ? (
          ...
          >
            {isSubmitting || loading ? REGISTER_FORM.SENDING : REGISTER_FORM.SUBMIT}
          </Button>
        </form>

        <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50 p-4">
          <p className="text-xs text-slate-700">{REGISTER_FORM.POST_SUBMIT_NOTE}</p>
        </div>
        </div>
      </div>
    </div>
