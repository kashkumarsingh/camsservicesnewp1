...
import { REGISTER_HERO, REGISTER_FEATURES } from './constants';

const FEATURE_ICONS = [Clock, Users, HelpCircle] as const;
...
export default function RegisterHeroSection() {
  return (
    <div className="lg:w-1/2">
      ...
      <p className="mt-3 text-sm text-slate-600">{REGISTER_HERO.SUBTITLE}</p>
