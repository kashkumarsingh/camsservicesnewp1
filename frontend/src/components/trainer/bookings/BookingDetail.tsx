      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          <div className="flex items-center gap-3 text-gray-600">
            <Package className="h-5 w-5 text-gcal-primary" />
            <span>Reference: {booking.reference}</span>
          </div>
          <div className="flex items-center gap-3 text-gray-600">
            <Users className="h-5 w-5 text-gcal-primary" />
        ...
        {(booking.parent?.address || booking.parent?.postcode) && (
          <div className="flex items-start gap-3 mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
            <MapPin className="h-5 w-5 text-gcal-primary flex-shrink-0 mt-0.5" aria-hidden />
            <div>
    ...
    <div className="border border-gray-200 rounded-lg p-4">
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <Calendar className="h-5 w-5 text-gcal-primary" />
          <div>
