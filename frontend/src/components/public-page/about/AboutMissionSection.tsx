      ...
      <Section title={sectionTitle} titleClassName="heading-text-shadow">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            {description ? (
              <p className="text-lg text-[#1E3A5F] mb-8 leading-relaxed whitespace-pre-wrap">{description}</p>
            ) : (
              <>
                <h2 className="text-4xl font-bold text-[#1E3A5F] mb-6 leading-tight">Specialist Support for Every Child</h2>
                <p className="text-lg text-[#1E3A5F] mb-6 leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#0080FF] to-[#00D4FF] rounded-lg flex items-center justify-center flex-shrink-0">
                      <Users className="text-white" size={20} />
                    </div>
                    <span className="text-sm font-semibold text-[#1E3A5F]">EHCP Support</span>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-xl border border-purple-100">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#0080FF] to-[#00D4FF] rounded-lg flex items-center justify-center flex-shrink-0">
                      <Award className="text-white" size={20} />
                    </div>
                    <span className="text-sm font-semibold text-[#1E3A5F]">Alternative Provision</span>
                  </div>
                </div>
                <p className="text-lg text-[#1E3A5F] mb-8 leading-relaxed">
          ...
          <div className="order-1 lg:order-2 relative w-full h-80 md:h-96 rounded-[30px] shadow-xl overflow-hidden">
            <Image
