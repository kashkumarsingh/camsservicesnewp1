...
export interface BookingPaymentStateCardProps {
  title: string;
  message: string;
...
const BookingPaymentStateCard: React.FC<BookingPaymentStateCardProps> = ({
  title,
  message,
  variant,
  onGoBack,
...
export default BookingPaymentStateCard;
