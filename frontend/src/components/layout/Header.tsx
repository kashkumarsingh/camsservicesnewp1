...
const Header: React.FC = () => {
  ...
  const mobileMenuContent = isMenuOpen ? (
    <div
      className="fixed inset-0 z-modal flex flex-col lg:hidden animate-fade-in"
      aria-modal="true"
      role="dialog"
      aria-label="Main menu"
    >
      <div className="absolute inset-0 bg-gradient-to-b from-white to-blue-50/30" aria-hidden />
      <div className="relative z-raised flex flex-col flex-1 min-h-0">
      <div className="flex items-center justify-between h-14 px-4 border-b border-primary-blue/20 flex-shrink-0">
      ...
      <p className="px-4 py-4 text-center text-xs text-navy-blue/70 border-t border-primary-blue/10 flex-shrink-0">
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-header isolate w-full border-b border-white/10 bg-navy-blue">
