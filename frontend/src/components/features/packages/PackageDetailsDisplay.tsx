    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-6 border-2 border-gray-200">
        <h3 className="text-2xl font-bold text-[#1E3A5F] mb-4 flex items-center gap-2">
          <Sparkles className="text-[#0080FF]" size={28} />
          Package Overview
        </h3>
      ...
      <div>
        <h3 className="text-2xl font-bold text-[#1E3A5F] mb-6 flex items-center gap-2">
          <CheckCircle2 className="text-[#0080FF]" size={28} />
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {pkg.features.map((feature, index) => (
            ...
            >
              <CheckCircle2 className="text-[#0080FF] flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-300" size={20} />
              <span className="text-gray-700 font-medium group-hover:text-[#0080FF] transition-colors duration-300">{feature}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-[#1E3A5F] mb-6 flex items-center gap-2">
          <Gift className="text-[#0080FF]" size={28} />
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {pkg.perks.map((perk, index) => (
            ...
            >
              ...
              <span className="text-[#1E3A5F] font-semibold group-hover:text-[#0080FF] transition-colors duration-300">{perk}</span>
            </div>
          ))}
        </div>
      </div>
