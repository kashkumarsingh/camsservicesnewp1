...
export const ROUTES = {
  ...
  /** Public Pages Content Management: edit content by slug (text only, no blocks). */
  DASHBOARD_ADMIN_PUBLIC_PAGE_CONTENT_EDIT: (slug: string) =>
    `/dashboard/admin/public-pages/content/${slug}`,
  ...
  DASHBOARD_ADMIN_REFERRALS: '/dashboard/admin/referrals',
  /** Google & Trustpilot reviews: sources + external reviews table. */
  DASHBOARD_ADMIN_REVIEWS: '/dashboard/admin/reviews',
  /** Payment gateways: Stripe (default), PayPal, etc. */
  DASHBOARD_ADMIN_PAYMENT_GATEWAYS: '/dashboard/admin/payment-gateways',
} as const;
