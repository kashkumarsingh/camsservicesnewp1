      ...
      <div className="py-20 bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
        <Section>
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-card border-2 border-gray-200 p-8 md:p-12 shadow-xl">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-card p-6 border-2 border-purple-100">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-card p-6 border-2 border-green-100">
                ...
                <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-card p-6 border-2 border-amber-100">
              ...
              {/* Quick Benefits */}
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-card p-6 mb-10 border-2 border-blue-200">
