                ...
                {testimonialsToRender.map((testimonial) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-gray-700 text-sm mb-4 italic leading-relaxed">&quot;{testimonial.quote}&quot;</p>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {testimonial.authorRole && <div className="text-xs text-gray-600">{testimonial.authorRole}</div>}
