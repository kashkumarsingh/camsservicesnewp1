...
const COMMUNITY_CHAPERONE_COPY: ServiceSeoCopy = {
  ...
  commissioning:
    'Commission chaperone services through a referral or consultation. CAMS services confirms capacity, agrees hours and can combine chaperone service hours with mentoring or family support through intervention packages. We cover West London including Ealing (HQ Greenford), Hounslow, Hillingdon, Brent, Harrow, Hammersmith and Fulham, Richmond, Kensington and Chelsea, plus Barnet, Enfield, Watford, Hertsmere, Slough, Essex towns including Chelmsford and Brentwood, and expanded Hertfordshire cover. See our service areas page for neighbourhood detail.',
