/**
 * Blog post detail page — CTA and UI strings.
 * Shared for marketing components outside route modules.
 */

export const BLOG_DETAIL_PAGE = {
  BACK_TO_BLOG: 'Back to Blog',
  CTA_TITLE: 'Ready to Take Action?',
  CTA_SUBTITLE: 'Reading is great, but real change happens with expert support.',
  CTA_PRIMARY: 'Book FREE Consultation',
  CTA_SECONDARY: 'View Our Packages',
  META_NOT_FOUND_TITLE: 'Blog Post Not Found',
} as const;
