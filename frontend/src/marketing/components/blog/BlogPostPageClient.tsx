...
import { BlogPostSidebar } from "@/marketing/components/blog/BlogPostSidebar";
  ...
  return (
    <PageShell maxWidthClassName="max-w-[1600px]">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(300px,380px)] lg:items-start lg:gap-12">
        <article className="min-w-0 pb-4 lg:pb-12">
        ...
        <BlogPostSidebar currentPost={post} relatedPosts={relatedPosts} />
      </div>
