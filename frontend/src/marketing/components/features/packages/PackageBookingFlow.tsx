...
import PackageCheckout from '@/marketing/components/features/packages/PackageCheckout';
import { ROUTES } from '@/shared/utils/routes';
import { Package, OriginalTrainer } from '@/marketing/components/features/booking/types';
