...
- Name: scripts/responsive-audit.spec.ts >> mobile-375 /checkout responsive sanity
...
Timeout: 5000ms
  ...
  Snapshot: responsive-mobile-375-_checkout.png

Call log:
  - Expect "toHaveScreenshot(responsive-mobile-375-_checkout.png)" with timeout 5000ms
