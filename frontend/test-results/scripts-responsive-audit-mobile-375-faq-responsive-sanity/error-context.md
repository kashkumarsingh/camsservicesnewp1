...
- Name: scripts/responsive-audit.spec.ts >> mobile-375 /faq responsive sanity
...
Timeout: 5000ms
  ...
  Snapshot: responsive-mobile-375-_faq.png

Call log:
  - Expect "toHaveScreenshot(responsive-mobile-375-_faq.png)" with timeout 5000ms
  ...
  - waiting for fonts to load...
  - fonts loaded
  - 2800 pixels (ratio 0.01 of all image pixels) are different.
