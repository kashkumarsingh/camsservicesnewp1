...
- Name: scripts/responsive-audit.spec.ts >> mobile-390 /packages responsive sanity
...
Timeout: 5000ms
  ...
  Snapshot: responsive-mobile-390-_packages.png

Call log:
  - Expect "toHaveScreenshot(responsive-mobile-390-_packages.png)" with timeout 5000ms
  ...
  - waiting for fonts to load...
  - fonts loaded
  - 2115 pixels (ratio 0.01 of all image pixels) are different.
