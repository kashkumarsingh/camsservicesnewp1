...
- Name: scripts/responsive-audit.spec.ts >> mobile-390 /services responsive sanity
...
Timeout: 5000ms
  ...
  Snapshot: responsive-mobile-390-_services.png

Call log:
  - Expect "toHaveScreenshot(responsive-mobile-390-_services.png)" with timeout 5000ms
  ...
  - waiting for fonts to load...
  - fonts loaded
  - 2101 pixels (ratio 0.01 of all image pixels) are different.
