...
- Name: scripts/responsive-audit.spec.ts >> mobile-375 / responsive sanity
...
Timeout: 5000ms
  ...
  Snapshot: responsive-mobile-375-_.png

Call log:
  - Expect "toHaveScreenshot(responsive-mobile-375-_.png)" with timeout 5000ms
