...
- Name: scripts/responsive-audit.spec.ts >> mobile-390 /contact responsive sanity
...
Timeout: 5000ms
  ...
  Snapshot: responsive-mobile-390-_contact.png

Call log:
  - Expect "toHaveScreenshot(responsive-mobile-390-_contact.png)" with timeout 5000ms
