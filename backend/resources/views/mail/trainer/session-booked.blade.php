@component('mail.layouts.cams', [
    ...
    <p style="margin:24px 0 12px 0;text-align:center;">
        <a href="{{ config('app.url') }}/trainer/bookings" style="display:inline-block;padding:12px 24px;background:linear-gradient(135deg,#0f172a,#1d4ed8);color:#ffffff;text-decoration:none;border-radius:8px;font-weight:600;font-size:15px;">View Session Details</a>
    </p>
