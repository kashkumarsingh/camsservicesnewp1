...
return [
    ...
    */
    ...
    'channels_per_intent' => [
        ...
        IntentType::PARENT_REGISTRATION_ADMIN => ['email'],
        IntentType::PARENT_REGISTERED => ['email'],
        IntentType::TRAINER_APPLICATION_RECEIVED => ['email'],
        IntentType::TRAINER_APPLICATION_SUBMITTED => ['in_app', 'email'],
        IntentType::ABSENCE_REQUEST_SUBMITTED => ['in_app', 'email'],
        IntentType::TRAINER_AVAILABILITY_UPDATED => ['in_app', 'email'],
        IntentType::CONTACT_SUBMISSION => ['email', 'whatsapp'],
        IntentType::CONTACT_SUBMISSION_THANK_YOU => ['email'],
        IntentType::REFERRAL_SUBMISSION_THANK_YOU => ['email'],
        IntentType::CHILD_CHECKLIST_SUBMITTED_ADMIN => ['in_app', 'email'],
        IntentType::REFERRAL_SUBMISSION => ['email'],
        IntentType::SAFEGUARDING_CONCERN_SUBMITTED => ['email'],
        IntentType::INCIDENT_REPORTED => ['email'],
        IntentType::NEWSLETTER_SUBSCRIBED => ['email'],
        IntentType::TRAINER_APPLICATION_RESPONSE_SUBMITTED => ['email'],
        IntentType::CHILD_ADDED_ADMIN => ['email'],
    ],
    ...
    'intent_to_notification_class' => [
        ...
        IntentType::PARENT_REGISTRATION_ADMIN => \App\Notifications\AdminParentRegistrationNotification::class,
        IntentType::PARENT_REGISTERED => \App\Notifications\ParentRegisteredNotification::class,
        IntentType::TRAINER_APPLICATION_RECEIVED => \App\Notifications\TrainerApplicationReceivedNotification::class,
        IntentType::TRAINER_APPLICATION_SUBMITTED => \App\Notifications\AdminTrainerApplicationSubmittedNotification::class,
        IntentType::APPLICATION_APPROVED => \App\Notifications\TrainerApplicationApprovedNotification::class,
        IntentType::APPLICATION_REJECTED => \App\Notifications\TrainerApplicationRejectedNotification::class,
        IntentType::APPLICATION_INFO_REQUESTED => \App\Notifications\TrainerApplicationInformationRequestedNotification::class,
        IntentType::CONTACT_SUBMISSION => \App\Notifications\NewContactSubmissionNotification::class,
        IntentType::CONTACT_SUBMISSION_THANK_YOU => \App\Notifications\ContactSubmissionThankYouNotification::class,
        IntentType::REFERRAL_SUBMISSION_THANK_YOU => \App\Notifications\ReferralSubmissionThankYouNotification::class,
        IntentType::CHILD_CHECKLIST_SUBMITTED_ADMIN => \App\Notifications\AdminChildChecklistSubmittedNotification::class,
        IntentType::REFERRAL_SUBMISSION => \App\Notifications\AdminReferralSubmissionNotification::class,
        IntentType::SAFEGUARDING_CONCERN_SUBMITTED => \App\Notifications\AdminSafeguardingConcernNotification::class,
        IntentType::INCIDENT_REPORTED => \App\Notifications\AdminIncidentReportedNotification::class,
        IntentType::NEWSLETTER_SUBSCRIBED => \App\Notifications\AdminNewsletterSubscribedNotification::class,
        IntentType::TRAINER_APPLICATION_RESPONSE_SUBMITTED => \App\Notifications\AdminTrainerApplicationResponseNotification::class,
        IntentType::CHILD_ADDED_ADMIN => \App\Notifications\AdminChildAddedNotification::class,
        IntentType::ABSENCE_REQUEST_SUBMITTED => \App\Notifications\AdminTrainerAbsenceRequestNotification::class,
        IntentType::TRAINER_AVAILABILITY_UPDATED => \App\Notifications\AdminTrainerAvailabilityUpdatedNotification::class,
    ],
    ...
    */
    'entity_model' => [
        ...
        'referral_submission' => \App\Models\ReferralSubmission::class,
        'safeguarding_concern' => \App\Models\SafeguardingConcern::class,
        'incident' => \App\Models\Incident::class,
        'newsletter_subscription' => \App\Models\NewsletterSubscription::class,
        'trainer_absence_request' => \App\Models\TrainerAbsenceRequest::class,
